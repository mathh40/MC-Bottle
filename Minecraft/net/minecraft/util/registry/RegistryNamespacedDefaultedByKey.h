...
template <typename KEY, typename VALUE> class RegistryNamespacedDefaultedByKey : public RegistryNamespaced<KEY, VALUE>
{
  public:
...
template <typename KEY, typename VALUE> void RegistryNamespacedDefaultedByKey<KEY, VALUE>::validateKey()
{
