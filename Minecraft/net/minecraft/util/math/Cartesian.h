...
template <typename T>
void CartesianRecurse(std::vector<std::vector<T>> &accum, std::vector<T> stack, std::vector<std::vector<T>> sequences,
                      T index)
{
...
template <typename T> T cartesianProduct(T sequences)
{
