...
EnumParticleTypes::EnumParticleTypes(std::string particleNameIn, int particleIDIn, bool shouldIgnoreRangeIn,
	int argumentCountIn)
	:particleName(particleNameIn), particleID(particleIDIn), shouldIgnoreRange(shouldIgnoreRangeIn), argumentCount(argumentCountIn)
{
}
...
void initParticle()
{
	std::vector<EnumParticleTypes> particles = {
