...
{
    return bold && italic && strikethrough && underlined && obfuscated && color && clickEvent && hoverEvent &&
           insertion;
}
...
{
    return fmt::format("Style{hasParent={}, color={}, bold={}, italic={}, underlined={}, obfuscated={}, clickEvent={}, "
                       "hoverEvent={}, insertion={}}",
                       parentStyle.value(), color.value(), bold.value(), italic.value(), getClickEvent().value(),
                       underlined.value(), obfuscated.value(), getHoverEvent().value(), getInsertion().value());
}
...
{
    if (a.getBold() == b.getBold() && a.getColor() == b.getColor() && a.getItalic() == b.getItalic() &&
        a.getObfuscated() == b.getObfuscated() && a.getStrikethrough() == b.getStrikethrough() &&
        a.getUnderlined() == b.getUnderlined())
    {
