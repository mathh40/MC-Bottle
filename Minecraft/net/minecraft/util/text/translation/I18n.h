...
class I18n
{
  public:
    ...
    template <typename... Args> static std::string translateToLocalFormatted(std::string key, Args... format);
...
template <typename... Args> std::string I18n::translateToLocalFormatted(std::string key, Args... format)
{
