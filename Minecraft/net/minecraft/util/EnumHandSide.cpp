...
EnumHandSide EnumHandSide::RIGHT =
    EnumHandSide(false, TextComponentTranslation("options.mainHand.right", new Object[0]));

EnumHandSide::EnumHandSide(bool left, ITextComponent nameIn) : left(left), handName(nameIn)
{
}
