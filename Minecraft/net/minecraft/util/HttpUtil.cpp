...
std::future<void> HttpUtil::downloadResourcePack(std::filesystem::path saveFile, std::string packUrl, std::unordered_map<std::string, std::string> p_180192_2_, int maxSize, std::optional<IProgressUpdate> p_180192_4_)
{
