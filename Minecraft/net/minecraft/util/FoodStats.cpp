...
void FoodStats::addStats(int foodLevelIn, float foodSaturationModifier)
{
...
void FoodStats::writeNBT(NBTTagCompound compound)
{
...
float FoodStats::getSaturationLevel()
{
	return foodSaturationLevel;
}

void FoodStats::setFoodLevel(int foodLevelIn)
{
