...
extern "C"
{
    ...
    constexpr auto ZLIB_VERSION = "1.2.11" constexpr auto ZLIB_VERNUM = 0x12b0 constexpr auto ZLIB_VER_MAJOR =
        1 constexpr auto ZLIB_VER_MINOR = 2 constexpr auto ZLIB_VER_REVISION = 11 constexpr auto ZLIB_VER_SUBREVISION =
            0
    ...
    */
    ...
    } using gz_header = gz_header_s;
    using gz_headerp  = gz_header FAR *;
    ...
    */
    ...
    constexpr auto Z_NO_FLUSH      = 0;
    constexpr auto Z_PARTIAL_FLUSH = 1;
    constexpr auto Z_SYNC_FLUSH = 2 constexpr auto Z_FULL_FLUSH = 3;
    constexpr auto Z_FINISH                                     = 4;
    constexpr auto Z_BLOCK                                      = 5;
    constexpr auto Z_TREES                                      = 6;
    /* Allowed flush values; see deflate() and inflate() below for details */

    constexpr auto Z_OK            = 0;
    constexpr auto Z_STREAM_END    = 1;
    constexpr auto Z_NEED_DICT     = 2;
    constexpr auto Z_ERRNO         = (-1);
    constexpr auto Z_STREAM_ERROR  = (-2);
    constexpr auto Z_DATA_ERROR    = (-3);
    constexpr auto Z_MEM_ERROR     = (-4);
    constexpr auto Z_BUF_ERROR     = (-5);
    constexpr auto Z_VERSION_ERROR = (-6);
    /* Return codes for the compression/decompression functions. Negative values
     * are errors, positive values are used for special but normal events.
     */

    constexpr auto Z_NO_COMPRESSION      = 0;
    constexpr auto Z_BEST_SPEED          = 1;
    constexpr auto Z_BEST_COMPRESSION    = 9;
    constexpr auto Z_DEFAULT_COMPRESSION = (-1);
    /* compression levels */

    constexpr auto Z_FILTERED     = 1;
    constexpr auto Z_HUFFMAN_ONLY = 2;
    constexpr auto Z_RLE          = 3;
    constexpr auto Z_FIXED = 4 constexpr auto Z_DEFAULT_STRATEGY = 0;
    /* compression strategy; see deflateInit2() below for details */

    constexpr auto Z_BINARY  = 0;
    constexpr auto Z_TEXT    = 1;
    constexpr auto Z_ASCII   = Z_TEXT; /* for compatibility with 1.2.2 and earlier */
    constexpr auto Z_UNKNOWN = 2;
    /* Possible values of the data_type field for deflate() */

    constexpr auto Z_DEFLATED = 8;
    /* The deflate compression method (the only one supported in this version) */

    constexpr auto Z_NULL = 0 /* for initializing zalloc, zfree, opaque */

        constexpr auto zlib_version = zlibVersion();
