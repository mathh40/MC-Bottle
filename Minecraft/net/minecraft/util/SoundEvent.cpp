...
int SoundEvent::soundEventId = 0;

SoundEvent::SoundEvent(ResourceLocation soundNameIn) : soundName(soundNameIn)
{
}

ResourceLocation SoundEvent::getSoundName() const
{
    return soundName;
}

void SoundEvent::registerSounds()
{
...
void SoundEvent::registerSound(std::string soundNameIn)
{
    ResourceLocation resourcelocation = ResourceLocation(soundNameIn);
    REGISTRY.registe(soundEventId++, resourcelocation, SoundEvent(resourcelocation));
}
