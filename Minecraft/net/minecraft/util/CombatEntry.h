...
{
  public:
    CombatEntry(const DamageSource::DamageSource &damageSrcIn, uint64_t timeIn, float healthAmount, float damageAmount,
                const std::string &fallSuffixIn, float fallDistanceIn);
