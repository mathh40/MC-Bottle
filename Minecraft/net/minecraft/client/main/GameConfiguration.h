...
struct GameConfiguration
{
    ...
    struct FolderInformation
    {
        ...
        FolderInformation(std::filesystem::path mcDataDirIn, std::filesystem::path resourcePacksDirIn,
                          std::filesystem::path assetsDirIn, std::optional<std::string> assetIndexIn);
    ...
    GameConfiguration(UserInformation userInfoIn, DisplayInformation displayInfoIn, FolderInformation folderInfoIn,
