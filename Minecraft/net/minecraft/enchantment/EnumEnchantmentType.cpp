...
EnumEnchantmentType::EnumEnchantmentType(Type type) : type(type)
{
...
bool EnumEnchantmentType::canEnchantItem(Item *itemIn)
{
    ...
    case Type::WEARABLE:
        bool flag = Util:: instanceof <ItemBlock>(itemIn) && Util:: instanceof
            <BlockPumpkin>(((ItemBlock *)itemIn)->getBlock());
        return Util:: instanceof <ItemArmor>(itemIn) || Util:: instanceof <ItemElytra>(itemIn) || Util:: instanceof
            <ItemSkull>(itemIn) || flag;
    }
    return false;
}
