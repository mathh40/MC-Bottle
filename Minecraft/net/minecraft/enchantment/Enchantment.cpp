...
{
    const std::array<EntityEquipmentSlot, 4> aentityequipmentslot = {
    ...
    REGISTRY.registe(0, ResourceLocation("protection"),
                     new EnchantmentProtection(Rarity::COMMON, EnchantmentProtection::Type::ALL, aentityequipmentslot));
    REGISTRY.registe(
        1, ResourceLocation("fire_protection"),
        new EnchantmentProtection(Rarity::UNCOMMON, EnchantmentProtection::Type::FIRE, aentityequipmentslot));
    REGISTRY.registe(
        2, ResourceLocation("feather_falling"),
        new EnchantmentProtection(Rarity::UNCOMMON, EnchantmentProtection::Type::FALL, aentityequipmentslot));
    REGISTRY.registe(
        3, ResourceLocation("blast_protection"),
        new EnchantmentProtection(Rarity::RARE, EnchantmentProtection::Type::EXPLOSION, aentityequipmentslot));
    REGISTRY.registe(
        4, ResourceLocation("projectile_protection"),
        new EnchantmentProtection(Rarity::UNCOMMON, EnchantmentProtection::Type::PROJECTILE, aentityequipmentslot));
    REGISTRY.registe(5, ResourceLocation("respiration"), new EnchantmentOxygen(Rarity::RARE, aentityequipmentslot));
    REGISTRY.registe(6, ResourceLocation("aqua_affinity"),
                     new EnchantmentWaterWorker(Rarity::RARE, aentityequipmentslot));
    REGISTRY.registe(7, ResourceLocation("thorns"), new EnchantmentThorns(Rarity::VERY_RARE, aentityequipmentslot));
    REGISTRY.registe(8, ResourceLocation("depth_strider"),
                     new EnchantmentWaterWalker(Rarity::RARE, aentityequipmentslot));
    REGISTRY.registe(9, ResourceLocation("frost_walker"), new EnchantmentFrostWalker(Rarity::RARE, feetequipmentslot));
    REGISTRY.registe(10, ResourceLocation("binding_curse"),
                     new EnchantmentBindingCurse(Rarity::VERY_RARE, aentityequipmentslot));
    REGISTRY.registe(16, ResourceLocation("sharpness"),
                     new EnchantmentDamage(Rarity::COMMON, 0, mainhandequipmentslot));
    REGISTRY.registe(17, ResourceLocation("smite"), new EnchantmentDamage(Rarity::UNCOMMON, 1, mainhandequipmentslot));
    REGISTRY.registe(18, ResourceLocation("bane_of_arthropods"),
                     new EnchantmentDamage(Rarity::UNCOMMON, 2, mainhandequipmentslot));
    REGISTRY.registe(19, ResourceLocation("knockback"),
                     new EnchantmentKnockback(Rarity::UNCOMMON, mainhandequipmentslot));
    REGISTRY.registe(20, ResourceLocation("fire_aspect"),
                     new EnchantmentFireAspect(Rarity::RARE, mainhandequipmentslot));
    REGISTRY.registe(21, ResourceLocation("looting"),
                     new EnchantmentLootBonus(Rarity::RARE, EnumEnchantmentType::WEAPON, mainhandequipmentslot));
    REGISTRY.registe(22, ResourceLocation("sweeping"),
                     new EnchantmentSweepingEdge(Rarity::RARE, mainhandequipmentslot));
    REGISTRY.registe(32, ResourceLocation("efficiency"), new EnchantmentDigging(Rarity::COMMON, mainhandequipmentslot));
    REGISTRY.registe(33, ResourceLocation("silk_touch"),
                     new EnchantmentUntouching(Rarity::VERY_RARE, mainhandequipmentslot));
    REGISTRY.registe(34, ResourceLocation("unbreaking"),
                     new EnchantmentDurability(Rarity::UNCOMMON, mainhandequipmentslot));
    REGISTRY.registe(35, ResourceLocation("fortune"),
                     new EnchantmentLootBonus(Rarity::RARE, EnumEnchantmentType::DIGGER, mainhandequipmentslot));
    ...
    REGISTRY.registe(51, ResourceLocation("infinity"),
                     new EnchantmentArrowInfinite(Rarity::VERY_RARE, mainhandequipmentslot));
    REGISTRY.registe(61, ResourceLocation("luck_of_the_sea"),
                     new EnchantmentLootBonus(Rarity::RARE, EnumEnchantmentType::FISHING_ROD, mainhandequipmentslot));
    REGISTRY.registe(
        62, ResourceLocation("lure"),
        new EnchantmentFishingSpeed(Rarity::RARE, EnumEnchantmentType::FISHING_ROD, mainhandequipmentslot));
    REGISTRY.registe(70, ResourceLocation("mending"),
                     new EnchantmentMending(Rarity::RARE, EntityEquipmentSlot::values()));
    REGISTRY.registe(71, ResourceLocation("vanishing_curse"),
                     new EnchantmentVanishingCurse(Rarity::VERY_RARE, EntityEquipmentSlot::values()));
}
