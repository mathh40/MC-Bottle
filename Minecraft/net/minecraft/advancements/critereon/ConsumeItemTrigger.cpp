...
ConsumeItemTrigger::Instance::Instance(ItemPredicate item)
    : AbstractCriterionInstance(ConsumeItemTrigger::ID), item(item)
{
}
...
ConsumeItemTrigger::Listeners::Listeners(PlayerAdvancements playerAdvancementsIn)
...
{
    ConsumeItemTrigger.Listeners consumeitemtrigger$listeners =
        (ConsumeItemTrigger.Listeners)this.listeners.get(playerAdvancementsIn);
...
{
    ConsumeItemTrigger.Listeners consumeitemtrigger$listeners =
        (ConsumeItemTrigger.Listeners)this.listeners.get(player.getAdvancements());
    if (consumeitemtrigger$listeners != null)
    {
