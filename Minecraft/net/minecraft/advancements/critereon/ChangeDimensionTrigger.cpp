...
ChangeDimensionTrigger::Listeners::Listeners(PlayerAdvancements playerAdvancementsIn) : playerAdvancements(playerAdvancementsIn) {}
...
void ChangeDimensionTrigger::addListener(PlayerAdvancements var1, ICriterionTrigger::Listener* var2) {
    ChangeDimensionTrigger.Listeners changedimensiontrigger$listeners = (ChangeDimensionTrigger.Listeners)this.listeners.get(playerAdvancementsIn);
...
void ChangeDimensionTrigger::trigger(EntityPlayerMP* player, DimensionType from, DimensionType to) {
    ChangeDimensionTrigger.Listeners changedimensiontrigger$listeners = (ChangeDimensionTrigger.Listeners)this.listeners.get(player.getAdvancements());
      if (changedimensiontrigger$listeners != null) {
