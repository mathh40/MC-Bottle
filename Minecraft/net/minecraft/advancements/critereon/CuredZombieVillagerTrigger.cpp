...
CuredZombieVillagerTrigger::Listeners::Listeners(PlayerAdvancements playerAdvancementsIn)
...
{
    CuredZombieVillagerTrigger.Listeners curedzombievillagertrigger$listeners =
        (CuredZombieVillagerTrigger.Listeners)this.listeners.get(playerAdvancementsIn);
...
{
    CuredZombieVillagerTrigger.Listeners curedzombievillagertrigger$listeners =
        (CuredZombieVillagerTrigger.Listeners)this.listeners.get(player.getAdvancements());
    if (curedzombievillagertrigger$listeners != null)
    {
