...
ConstructBeaconTrigger::Listeners::Listeners(PlayerAdvancements playerAdvancementsIn) : playerAdvancements(playerAdvancementsIn) {}
...
void ConstructBeaconTrigger::addListener(PlayerAdvancements playerAdvancementsIn, ICriterionTrigger::Listener* listener) {
    ConstructBeaconTrigger.Listeners constructbeacontrigger$listeners = (ConstructBeaconTrigger.Listeners)this.listeners.get(playerAdvancementsIn);
...
void ConstructBeaconTrigger::trigger(EntityPlayerMP* player, TileEntityBeacon* beacon) {
    ConstructBeaconTrigger.Listeners constructbeacontrigger$listeners = (ConstructBeaconTrigger.Listeners)this.listeners.get(player.getAdvancements());
      if (constructbeacontrigger$listeners != null) {
