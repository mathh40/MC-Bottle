...
class AdvancementRewards
{
  public:
    ...
    AdvancementRewards(uint64_t experience, std::vector<ResourceLocation> loot, std::vector<ResourceLocation> recipes,
...
namespace ns
{
void to_json(json &j, const class AdvancementRewards &p)
{
}

void from_json(const json &j, class AdvancementRewards &p)
{
}
} // namespace ns
