...
{
public:
    DisplayInfo(const ItemStack& icon, ITextComponent* title, ITextComponent* description, std::optional<ResourceLocation> background, FrameType frame, bool showToast, bool announceToChat, bool hidden);
