...
void Block::registerBlocks()
{
    ...
    registerBlock(2, "grass",
                  (BlockGrass()).setHardness(0.6F).setSoundType(SoundType::PLANT).setTranslationKey("grass"));
    ...
    Block block1 =
        (BlockPlanks()).setHardness(2.0F).setResistance(5.0F).setSoundType(SoundType::WOOD).setTranslationKey("wood");
    ...
    registerBlock(8, "flowing_water",
                  (BlockDynamicLiquid(Material.WATER))
                      .setHardness(100.0F)
                      .setLightOpacity(3)
                      .setTranslationKey("water")
                      .disableStats());
    registerBlock(9, "water",
                  (BlockStaticLiquid(Material.WATER))
                      .setHardness(100.0F)
                      .setLightOpacity(3)
                      .setTranslationKey("water")
                      .disableStats());
    registerBlock(10, "flowing_lava",
                  (BlockDynamicLiquid(Material.LAVA))
                      .setHardness(100.0F)
                      .setLightLevel(1.0F)
                      .setTranslationKey("lava")
                      .disableStats());
    registerBlock(11, "lava",
                  (BlockStaticLiquid(Material.LAVA))
                      .setHardness(100.0F)
                      .setLightLevel(1.0F)
                      .setTranslationKey("lava")
                      .disableStats());
    ...
    registerBlock(
        14, "gold_ore",
        (BlockOre()).setHardness(3.0F).setResistance(5.0F).setSoundType(SoundType.STONE).setTranslationKey("oreGold"));
    registerBlock(
        15, "iron_ore",
        (BlockOre()).setHardness(3.0F).setResistance(5.0F).setSoundType(SoundType.STONE).setTranslationKey("oreIron"));
    registerBlock(
        16, "coal_ore",
        (BlockOre()).setHardness(3.0F).setResistance(5.0F).setSoundType(SoundType.STONE).setTranslationKey("oreCoal"));
    ...
    registerBlock(
        20, "glass",
        (BlockGlass(Material.GLASS, false)).setHardness(0.3F).setSoundType(SoundType.GLASS).setTranslationKey("glass"));
    registerBlock(
        21, "lapis_ore",
        (BlockOre()).setHardness(3.0F).setResistance(5.0F).setSoundType(SoundType.STONE).setTranslationKey("oreLapis"));
    registerBlock(22, "lapis_block",
                  (Block(Material.IRON, MapColor.LAPIS))
                      .setHardness(3.0F)
                      .setResistance(5.0F)
                      .setSoundType(SoundType.STONE)
    ...
    registerBlock(26, "bed",
                  (BlockBed()).setSoundType(SoundType.WOOD).setHardness(0.2F).setTranslationKey("bed").disableStats());
    registerBlock(27, "golden_rail",
                  (BlockRailPowered()).setHardness(0.7F).setSoundType(SoundType.METAL).setTranslationKey("goldenRail"));
    registerBlock(
        28, "detector_rail",
        (BlockRailDetector()).setHardness(0.7F).setSoundType(SoundType.METAL).setTranslationKey("detectorRail"));
    ...
    registerBlock(41, "gold_block",
                  (Block(Material.IRON, MapColor.GOLD))
                      .setHardness(3.0F)
                      .setResistance(10.0F)
    ...
    registerBlock(42, "iron_block",
                  (Block(Material.IRON, MapColor.IRON))
                      .setHardness(5.0F)
                      .setResistance(10.0F)
                      .setSoundType(SoundType.METAL)
    ...
    registerBlock(44, "stone_slab",
                  (BlockHalfStoneSlab())
                      ...
                      .setSoundType(SoundType.STONE)
                      .setTranslationKey("stoneSlab"));
    Block block5 = (Block(Material.ROCK, MapColor.RED))
                       .setHardness(2.0F)
                       .setResistance(10.0F)
                       .setSoundType(SoundType.STONE)
    ...
    registerBlock(
        54, "chest",
        (BlockChest(BlockChest.Type.BASIC)).setHardness(2.5F).setSoundType(SoundType.WOOD).setTranslationKey("chest"));
    ...
    registerBlock(57, "diamond_block",
                  (Block(Material.IRON, MapColor.DIAMOND))
                      .setHardness(5.0F)
                      .setResistance(10.0F)
                      .setSoundType(SoundType.METAL)
    ...
    registerBlock(
        63, "standing_sign",
        (BlockStandingSign()).setHardness(1.0F).setSoundType(SoundType.WOOD).setTranslationKey("sign").disableStats());
    registerBlock(64, "wooden_door",
                  (BlockDoor(Material.WOOD))
                      .setHardness(3.0F)
                      .setSoundType(SoundType.WOOD)
    ...
    registerBlock(
        68, "wall_sign",
        (BlockWallSign()).setHardness(1.0F).setSoundType(SoundType.WOOD).setTranslationKey("sign").disableStats());
    ...
    registerBlock(
        ...
        (BlockRedstoneTorch(false)).setHardness(0.0F).setSoundType(SoundType.WOOD).setTranslationKey("notGate"));
    registerBlock(76, "redstone_torch",
                  (BlockRedstoneTorch(true))
                      .setHardness(0.0F)
                      .setLightLevel(0.5F)
                      .setSoundType(SoundType.WOOD)
    ...
    registerBlock(
        78, "snow_layer",
        (BlockSnow()).setHardness(0.1F).setSoundType(SoundType.SNOW).setTranslationKey("snow").setLightOpacity(0));
    registerBlock(
        79, "ice",
        (BlockIce()).setHardness(0.5F).setLightOpacity(3).setSoundType(SoundType.GLASS).setTranslationKey("ice"));
    registerBlock(80, "snow",
                  (BlockSnowBlock()).setHardness(0.2F).setSoundType(SoundType.SNOW).setTranslationKey("snow"));
    ...
    registerBlock(
        83, "reeds",
        (BlockReed()).setHardness(0.0F).setSoundType(SoundType.PLANT).setTranslationKey("reeds").disableStats());
    ...
    registerBlock(85, "fence",
                  (BlockFence(Material.WOOD, BlockPlanks.EnumType.OAK.getMapColor()))
                      .setHardness(2.0F)
                      .setResistance(5.0F)
                      .setSoundType(SoundType.WOOD)
    ...
    registerBlock(99, "brown_mushroom_block",
                  (BlockHugeMushroom(Material.WOOD, MapColor.DIRT, block3))
                      .setHardness(0.2F)
                      .setSoundType(SoundType.WOOD)
                      .setTranslationKey("mushroom"));
    registerBlock(100, "red_mushroom_block",
                  (BlockHugeMushroom(Material.WOOD, MapColor.RED, block4))
                      .setHardness(0.2F)
                      .setSoundType(SoundType.WOOD)
                      .setTranslationKey("mushroom"));
    registerBlock(101, "iron_bars",
                  (BlockPane(Material.IRON, true))
                      .setHardness(5.0F)
                      .setResistance(10.0F)
                      .setSoundType(SoundType.METAL)
                      .setTranslationKey("fenceIron"));
    registerBlock(102, "glass_pane",
                  (BlockPane(Material.GLASS, false))
                      .setHardness(0.3F)
                      .setSoundType(SoundType.GLASS)
                      .setTranslationKey("thinGlass"));
    ...
    registerBlock(
        ...
        (BlockStairs(block8.getDefaultState().withProperty(BlockStoneBrick.VARIANT, BlockStoneBrick.EnumType.DEFAULT)))
    ...
    Block block10 = (BlockNetherBrick())
                        .setHardness(2.0F)
                        .setResistance(10.0F)
                        .setSoundType(SoundType.STONE)
    ...
    registerBlock(113, "nether_brick_fence",
                  (BlockFence(Material.ROCK, MapColor.NETHERRACK))
                      .setHardness(2.0F)
                      .setResistance(10.0F)
                      .setSoundType(SoundType.STONE)
    ...
    registerBlock(
        ...
        (BlockEnchantmentTable()).setHardness(5.0F).setResistance(2000.0F).setTranslationKey("enchantmentTable"));
    ...
    registerBlock(121, "end_stone",
                  (Block(Material.ROCK, MapColor.SAND))
                      .setHardness(3.0F)
                      .setResistance(15.0F)
                      .setSoundType(SoundType.STONE)
    ...
    registerBlock(
        ...
        (BlockRedstoneLight(true)).setHardness(0.3F).setSoundType(SoundType.GLASS).setTranslationKey("redstoneLight"));
    ...
    registerBlock(
        127, "cocoa",
        (BlockCocoa()).setHardness(0.2F).setResistance(5.0F).setSoundType(SoundType.WOOD).setTranslationKey("cocoa"));
    registerBlock(
        128, "sandstone_stairs",
        (BlockStairs(block2.getDefaultState().withProperty(BlockSandStone.TYPE, BlockSandStone.EnumType.SMOOTH)))
    ...
    registerBlock(133, "emerald_block",
                  (Block(Material.IRON, MapColor.EMERALD))
                      .setHardness(5.0F)
                      .setResistance(10.0F)
                      .setSoundType(SoundType.METAL)
    ...
    registerBlock(137, "command_block",
                  (BlockCommandBlock(MapColor.BROWN))
                      .setBlockUnbreakable()
                      .setResistance(6000000.0F)
                      .setTranslationKey("commandBlock"));
    ...
    registerBlock(152, "redstone_block",
                  (BlockCompressedPowered(Material.IRON, MapColor.TNT))
                      .setHardness(5.0F)
                      .setResistance(10.0F)
                      .setSoundType(SoundType.METAL)
    ...
    registerBlock(
        156, "quartz_stairs",
        (BlockStairs(block11.getDefaultState().withProperty(BlockQuartz.VARIANT, BlockQuartz.EnumType.DEFAULT)))
            .setTranslationKey("stairsQuartz"));
    registerBlock(
        157, "activator_rail",
        (BlockRailPowered()).setHardness(0.7F).setSoundType(SoundType.METAL).setTranslationKey("activatorRail"));
    ...
    registerBlock(
        164, "dark_oak_stairs",
        (BlockStairs(block1.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.DARK_OAK)))
    ...
    registerBlock(167, "iron_trapdoor",
                  (BlockTrapDoor(Material.IRON))
                      .setHardness(5.0F)
                      .setSoundType(SoundType.METAL)
                      .setTranslationKey("ironTrapdoor")
                      .disableStats());
    ...
    registerBlock(169, "sea_lantern",
                  (BlockSeaLantern(Material.GLASS))
                      .setHardness(0.3F)
                      .setSoundType(SoundType.GLASS)
                      .setLightLevel(1.0F)
    ...
    registerBlock(173, "coal_block",
                  (Block(Material.ROCK, MapColor.BLACK))
                      .setHardness(5.0F)
                      .setResistance(10.0F)
                      .setSoundType(SoundType.STONE)
    ...
    Block block12 =
        (BlockRedSandstone()).setSoundType(SoundType.STONE).setHardness(0.8F).setTranslationKey("redSandStone");
    registerBlock(179, "red_sandstone", block12);
    registerBlock(
        180, "red_sandstone_stairs",
        (BlockStairs(block12.getDefaultState().withProperty(BlockRedSandstone.TYPE, BlockRedSandstone.EnumType.SMOOTH)))
    ...
    registerBlock(
        200, "chorus_flower",
        (BlockChorusFlower()).setHardness(0.4F).setSoundType(SoundType.WOOD).setTranslationKey("chorusFlower"));
    Block block13 = (Block(Material.ROCK, MapColor.MAGENTA))
                        .setHardness(1.5F)
                        .setResistance(10.0F)
                        .setSoundType(SoundType.STONE)
                        .setCreativeTab(CreativeTabs.BUILDING_BLOCKS)
    ...
    registerBlock(202, "purpur_pillar",
                  (BlockRotatedPillar(Material.ROCK, MapColor.MAGENTA))
                      .setHardness(1.5F)
                      .setResistance(10.0F)
                      .setSoundType(SoundType.STONE)
                      .setCreativeTab(CreativeTabs.BUILDING_BLOCKS)
    ...
    Block block14 = (BlockGrassPath())
                        .setHardness(0.65F)
                        .setSoundType(SoundType.PLANT)
                        .setTranslationKey("grassPath")
                        .disableStats();
    ...
    registerBlock(210, "repeating_command_block",
                  (BlockCommandBlock(MapColor.PURPLE))
                      .setBlockUnbreakable()
                      .setResistance(6000000.0F)
                      .setTranslationKey("repeatingCommandBlock"));
    registerBlock(211, "chain_command_block",
                  (BlockCommandBlock(MapColor.GREEN))
                      .setBlockUnbreakable()
                      .setResistance(6000000.0F)
                      .setTranslationKey("chainCommandBlock"));
    ...
    registerBlock(214, "nether_wart_block",
                  (Block(Material.GRASS, MapColor.RED))
                      .setCreativeTab(CreativeTabs.BUILDING_BLOCKS)
                      .setHardness(1.0F)
                      .setSoundType(SoundType.WOOD)
    ...
    registerBlock(
        251, "concrete",
        (BlockColored(Material.ROCK)).setHardness(1.8F).setSoundType(SoundType.STONE).setTranslationKey("concrete"));
    registerBlock(
        252, "concrete_powder",
        (BlockConcretePowder()).setHardness(0.5F).setSoundType(SoundType.SAND).setTranslationKey("concretePowder"));
    registerBlock(
        255, "structure_block",
        (BlockStructure()).setBlockUnbreakable().setResistance(6000000.0F).setTranslationKey("structureBlock"));
...
Block::Block(Material materialIn) : Block(materialIn, materialIn.getMaterialMapColor())
{
}
...
{
    return instanceof <BlockShulkerBox>(attachBlock) || instanceof <BlockLeaves>(attachBlock) || instanceof
        <BlockTrapDoor>(attachBlock) || attachBlock == Blocks.BEACON || attachBlock == Blocks.CAULDRON ||
            attachBlock == Blocks.GLASS || attachBlock == Blocks.GLOWSTONE || attachBlock == Blocks.ICE ||
...
void Block::spawnAsEntity(World *worldIn, const BlockPos &pos, ItemStack stack)
{
    if (!worldIn->isRemote && !stack.isEmpty() && worldIn->getGameRules().getBoolean("doTileDrops"))
    {
        ...
        EntityItem *entityitem =
            new EntityItem(worldIn, (double)pos.getx() + d0, (double)pos.gety() + d1, (double)pos.getz() + d2, stack);
...
void Block::dropXpOnBlockBreak(World *worldIn, const BlockPos &pos, int32_t amount)
{
    if (!worldIn->isRemote && worldIn->getGameRules().getBoolean("doTileDrops"))
    {
        while (amount > 0)
        {
            ...
            amount -= i;
            worldIn->spawnEntity(
                EntityXPOrb(worldIn, (double)pos.getx() + 0.5, (double)pos.gety() + 0.5, (double)pos.getz() + 0.5, i));
        }
    }
}
...
std::optional<RayTraceResult> Block::rayTrace(BlockPos pos, Vec3d start, Vec3d end, AxisAlignedBB boundingBox)
{
    ...
    return (!raytraceresult) ? std::nullopt
                             : RayTraceResult(raytraceresult.value().hitVec.add((double)pos.getx(), (double)pos.gety(),
                                                                                (double)pos.getz()),
...
Vec3d Block::getOffset(IBlockState *state, IBlockAccess *worldIn, const BlockPos &pos)
{
    ...
    else
    {
        ...
        return Vec3d(
            ...
            block$enumoffsettype == EnumOffsetType::XYZ ? ((double)((float)(i >> 20 & 15L) / 15.0F) - 1.0) * 0.2 : 0.0,
