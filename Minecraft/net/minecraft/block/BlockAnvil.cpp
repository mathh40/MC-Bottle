...
BlockFaceShape BlockAnvil::getBlockFaceShape(IBlockAccess *worldIn, IBlockState *state, const BlockPos &pos,
                                             EnumFacing face)
{
...
IBlockState BlockAnvil::getStateForPlacement(World *worldIn, const BlockPos &pos, EnumFacing facing, float hitX,
                                             float hitY, float hitZ, int32_t meta, EntityLivingBase *placer)
{
...
void BlockAnvil::onBroken(World *worldIn, const BlockPos &pos)
{
    worldIn->playEvent(1029, pos, 0);
}

bool BlockAnvil::shouldSideBeRendered(IBlockState *blockState, IBlockAccess *blockAccess, const BlockPos &pos,
                                      EnumFacing side)
{
    return true;
}
...
BlockAnvil::Anvil::Anvil(World *worldIn, const BlockPos &pos) : world(worldIn), position(pos)
{
}
...
{
    return BlockStateContainer(this, {FACING, DAMAGE});
}
