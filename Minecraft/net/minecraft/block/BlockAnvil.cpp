...
bool BlockAnvil::onBlockActivated(World *worldIn, BlockPos pos, IBlockState *state, EntityPlayer *playerIn,
                                  EnumHand hand,
...
void BlockAnvil::onBroken(World worldIn, BlockPos pos) { worldIn.playEvent(1029, pos, 0); }
...
BlockStateContainer BlockAnvil::createBlockState() {
    return BlockStateContainer(this, IProperty[]
    {
        FACING, DAMAGE
    }
    )
