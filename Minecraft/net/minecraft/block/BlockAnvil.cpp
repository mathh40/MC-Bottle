...
BlockAnvil::Anvil::Anvil(World worldIn, BlockPos pos) : world(worldIn), position(pos) {}
...
BlockStateContainer BlockAnvil::createBlockState() { return BlockStateContainer(this, IProperty[]{FACING, DAMAGE}); }
