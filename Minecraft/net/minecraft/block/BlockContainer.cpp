...
BlockContainer::BlockContainer(Material materialIn) : Block(materialIn, materialIn.getMaterialMapColor())
{
}

BlockContainer::BlockContainer(Material materialIn, MapColor color) : Block(materialIn, color)
{
    bTileEntity = true;
}
