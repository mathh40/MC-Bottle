...
public:
	...
	virtual int32_t getWeakPower(IBlockAccess* var1, const BlockPos& var2, EnumFacing& var3) = 0;
	virtual bool hasComparatorInputOverride() = 0;
	virtual int32_t getComparatorInputOverride(World* var1, const BlockPos& var2) = 0;
	...
	virtual int32_t getStrongPower(IBlockAccess* var1, const BlockPos& var2, EnumFacing& var3) = 0;
	...
	virtual void addCollisionBoxToList(World* var1, const BlockPos& var2, AxisAlignedBB var3, std::optional<std::vector<AxisAlignedBB>>& var4, Entity* var5, bool var6) = 0;
