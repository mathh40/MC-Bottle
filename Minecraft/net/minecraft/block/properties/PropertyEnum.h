...
template <typename T> class PropertyEnum : public PropertyHelper<T>
{
  public:
...
template <typename T> std::optional<std::any> PropertyEnum<T>::parseValue(std::string_view value)
{
...
template <typename T> PropertyEnum<T> PropertyEnum<T>::create(std::string_view name, std::set<T> &values)
{
