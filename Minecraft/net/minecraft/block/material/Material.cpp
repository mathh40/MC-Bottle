...
Material Material::WOOD(MapColor::WOOD).setBurning();
Material Material::ROCK(MapColor::STONE).setRequiresTool();
Material Material::IRON(MapColor::IRON).setRequiresTool();
Material Material::ANVIL(MapColor::IRON).setRequiresTool().setImmovableMobility();
...
Material Material::LEAVES(MapColor::FOLIAGE).setBurning().setTranslucent().setNoPushMobility();
...
Material Material::CLOTH(MapColor::CLOTH).setBurning();
...
Material Material::GLASS(MapColor::AIR).setTranslucent().setAdventureModeExempt();
Material Material::REDSTONE_LIGHT(MapColor::AIR).setAdventureModeExempt();
Material Material::TNT(MapColor::TNT).setBurning().setTranslucent();
Material Material::CORAL(MapColor::FOLIAGE).setNoPushMobility();
Material Material::ICE(MapColor::ICE).setTranslucent().setAdventureModeExempt();
Material Material::PACKED_ICE(MapColor::ICE).setAdventureModeExempt();
Material Material::SNOW = MaterialLogic(MapColor::SNOW).setReplaceable().setTranslucent().setRequiresTool().setNoPushMobility();
Material Material::CRAFTED_SNOW(MapColor::SNOW).setRequiresTool();
Material Material::CACTUS(MapColor::FOLIAGE).setTranslucent().setNoPushMobility();
Material Material::CLAY(MapColor::CLAY);
Material Material::GOURD(MapColor::FOLIAGE).setNoPushMobility();
Material Material::DRAGON_EGG(MapColor::FOLIAGE).setNoPushMobility();
Material Material::PORTAL = MaterialPortal(MapColor::AIR).setImmovableMobility();
Material Material::CAKE(MapColor::AIR).setNoPushMobility();
Material Material::WEB(MapColor::CLOTH){
   public boolean blocksMovement() {
	  return false;
   }
	}).setRequiresTool().setNoPushMobility();
Material Material::PISTON(MapColor::STONE).setImmovableMobility();
Material Material::BARRIER(MapColor::AIR).setRequiresTool().setImmovableMobility();
