...
SoundType SoundType::WOOD(1.0F, 1.0F, SoundEvents::BLOCK_WOOD_BREAK, SoundEvents::BLOCK_WOOD_STEP,
                          SoundEvents::BLOCK_WOOD_PLACE, SoundEvents::BLOCK_WOOD_HIT, SoundEvents::BLOCK_WOOD_FALL);
SoundType SoundType::GROUND(1.0F, 1.0F, SoundEvents::BLOCK_GRAVEL_BREAK, SoundEvents::BLOCK_GRAVEL_STEP,
                            SoundEvents::BLOCK_GRAVEL_PLACE, SoundEvents::BLOCK_GRAVEL_HIT,
