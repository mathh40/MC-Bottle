...
public:
    ...
    bool onBlockActivated(World *worldIn, BlockPos pos, IBlockState *state, EntityPlayer playerIn, EnumHand hand,
    ...
    bool shouldSideBeRendered(IBlockState *blockState, IBlockAccess *blockAccess, BlockPos pos,
