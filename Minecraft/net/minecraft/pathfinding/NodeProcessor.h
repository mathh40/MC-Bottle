...
class NodeProcessor
{
  public:
    ...
    virtual int32_t findPathOptions(std::vector<PathPoint> &var1, PathPoint var2, PathPoint var3, float var4) = 0;
    virtual PathNodeType getPathNodeType(IBlockAccess *var1, int32_t var2, int32_t var3, int32_t var4,
                                         EntityLiving *var5, int32_t var6, int32_t var7, int var8, bool var9,
                                         bool var10)                                                          = 0;
  ...
  protected:
    virtual std::optional<PathPoint> openPoint(int32_t x, int32_t y, int32_t z);
