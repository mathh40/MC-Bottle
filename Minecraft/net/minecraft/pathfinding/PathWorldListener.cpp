...
void PathWorldListener::notifyBlockUpdate(World *worldIn, BlockPos& pos, IBlockState *oldState, IBlockState *newState, int32_t flags)
{
...
void PathWorldListener::markBlockRangeForRenderUpdate(int32_t x1, int32_t y1, int32_t z1, int32_t x2, int32_t y2, int32_t z2) {}

void PathWorldListener::playSoundToAllNearExcept(EntityPlayer *player, SoundEvent& soundIn, SoundCategory& category, double x, double y, double z, float volume, float pitch) {}

void PathWorldListener::spawnParticle(int32_t particleID, bool ignoreRange, double xCoord, double yCoord, double zCoord, double xSpeed, double ySpeed, double zSpeed, std::initializer_list<int32_t> parameters) {}
