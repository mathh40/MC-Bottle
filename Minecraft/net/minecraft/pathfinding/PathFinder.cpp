...
PathFinder::PathFinder(NodeProcessor *processor)
  :nodeProcessor(processor)
{
  pathOptions.resize(32);
}

std::optional<Path> PathFinder::findPath(IBlockAccess* worldIn, EntityLiving* entitylivingIn, Entity* targetEntity, float maxDistance)
{
...
std::optional<Path> PathFinder::findPath(IBlockAccess* worldIn, EntityLiving* entitylivingIn, BlockPos& targetPos, float maxDistance)
{
...
std::optional<Path> PathFinder::findPath(IBlockAccess* worldIn, EntityLiving* entitylivingIn, double x, double y, double z, float maxDistance)
{
  path.clearPath();
