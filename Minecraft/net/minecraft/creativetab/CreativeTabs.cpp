...
Tools::Tools()
    :CreativeTabs(8, "tools"){
    std::vector<EnumEnchantmentType> types = {EnumEnchantmentType::ALL, EnumEnchantmentType::DIGGER, EnumEnchantmentType::FISHING_ROD, EnumEnchantmentType::BREAKABLE};
...
Combat::Combat()
    :CreativeTabs(9, "combat"){
    std::vector<EnumEnchantmentType> types = {EnumEnchantmentType::ALL, EnumEnchantmentType::ARMOR, EnumEnchantmentType::ARMOR_FEET, EnumEnchantmentType::ARMOR_HEAD, EnumEnchantmentType::ARMOR_LEGS, EnumEnchantmentType::ARMOR_CHEST, EnumEnchantmentType::BOW, EnumEnchantmentType::WEAPON, EnumEnchantmentType::WEARABLE, EnumEnchantmentType::BREAKABLE};
    setRelevantEnchantmentTypes(types);
}
