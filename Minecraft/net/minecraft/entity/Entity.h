...
class Entity : public ICommandSender, public IWorldNameable
{
  public:
    ...
    virtual void setPositionAndRotationDirect(double x, double y, double z, float yaw, float pitch,
    ...
    virtual float getExplosionResistance(Explosion explosionIn, World *worldIn, BlockPos pos,
                                         IBlockState *blockStateIn);
    virtual bool canExplosionDestroyBlock(Explosion explosionIn, World *worldIn, BlockPos pos,
