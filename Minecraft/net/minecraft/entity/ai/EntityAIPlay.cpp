...
EntityAIPlay::EntityAIPlay(EntityVillager *villagerIn, double speedIn) : villager(villagerIn), speed(speedIn)
{
    setMutexBits(1);
}
...
bool EntityAIPlay::shouldExecute()
{
    ...
    {
        auto list = villager->world->getEntitiesWithinAABB(EntityVillager.class,
                                                           villager->getEntityBoundingBox().grow(6.0, 3.0, 6.0));
