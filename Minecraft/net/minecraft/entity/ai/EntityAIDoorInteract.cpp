...
EntityAIDoorInteract::EntityAIDoorInteract(EntityLiving *entityIn)
    :doorPosition(BlockPos::ORIGIN),entity(entityIn)
{
...
BlockDoor* EntityAIDoorInteract::getBlockDoor(BlockPos pos)
{
    ...
    return Util::instanceof<BlockDoor>(block) && iblockstate->getMaterial() == Material::WOOD ? (BlockDoor*)block : nullptr;
}
