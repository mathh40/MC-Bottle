...
namespace RandomPositionGenerator
{
        ...
        std::optional<Vec3d> p_191379_3_, bool p_191379_4_)
    {
        ...
        {
            double d0 = p_191379_0_->getHomePosition().distanceSq(MathHelper::floor(p_191379_0_->posX), MathHelper::floor(p_191379_0_->posY), MathHelper::floor(p_191379_0_->posZ)) + 4.0;
