...
EntityAIFollowParent::EntityAIFollowParent(EntityAnimal *animal, double speed) : childAnimal(animal), moveSpeed(speed)
{
}
...
bool EntityAIFollowParent::shouldExecute()
{
    ...
    {
        std::vector<EntityAnimal *> list = childAnimal->world.getEntitiesWithinAABB(
            childAnimal->getClass(), childAnimal->getEntityBoundingBox().grow(8.0, 4.0, 8.0));
