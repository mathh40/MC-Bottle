...
{
  public:
    EntityAIAvoidEntity(EntityCreature *entityIn, std::type_index classToAvoidIn, float avoidDistanceIn,
                        double farSpeedIn, double nearSpeedIn);
    EntityAIAvoidEntity(EntityCreature *entityIn, std::type_index classToAvoidIn,
                        std::function<bool(Entity *p_apply_1_)> avoidTargetSelectorIn, float avoidDistanceIn,
                        double farSpeedIn, double nearSpeedIn);
