...
{
  public:
    EntityAIAttackRanged(IRangedAttackMob *attacker, double movespeed, int32_t maxAttackTime,
                         float maxAttackDistanceIn);
    EntityAIAttackRanged(IRangedAttackMob *attacker, double movespeed, int32_t p_i1650_4_, int32_t maxAttackTime,
                         float maxAttackDistanceIn);
