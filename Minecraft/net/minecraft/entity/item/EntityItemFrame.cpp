...
EntityItemFrame::EntityItemFrame(World *worldIn) : EntityHanging(worldIn)
{
}

EntityItemFrame::EntityItemFrame(World *worldIn, BlockPos pos, EnumFacing facing) : EntityHanging(worldIn, pos)
{
