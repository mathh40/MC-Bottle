...
DataParameter EntityMinecartFurnace::POWERED =
    EntityDataManager::createKey(EntityMinecartFurnace.class, DataSerializers::BOOLEAN);

EntityMinecartFurnace::EntityMinecartFurnace(World *worldIn) : EntityMinecart(worldIn)
{
}
...
{
    return (isMinecartPowered() ? Blocks::LIT_FURNACE : Blocks::FURNACE)
        ->getDefaultState()
