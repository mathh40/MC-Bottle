...
EntityPainting::EnumArt EntityPainting::EnumArt::SKULL_AND_ROSES =
    EntityPainting::EnumArt("SkullAndRoses", 32, 32, 128, 128);
...
EntityPainting::EnumArt EntityPainting::EnumArt::BURNING_SKULL =
    EntityPainting::EnumArt("BurningSkull", 64, 64, 128, 192);
...
EntityPainting::EntityPainting(World *worldIn) : EntityHanging(worldIn)
{
}

EntityPainting::EntityPainting(World *worldIn, BlockPos pos, EnumFacing facing) : EntityHanging(worldIn, pos)
{
    ...
    if (!list.empty())
    {
        ...
        list.erase(
            std::remove_if(list.begin(), list.end(),
                           [&](EntityPainting::EnumArt *enumart1) { return enumart1->sizeX * enumart1->sizeY < i; }),
            list.end());
