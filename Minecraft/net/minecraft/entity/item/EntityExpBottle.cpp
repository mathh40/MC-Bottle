...
EntityExpBottle::EntityExpBottle(World *worldIn) : EntityThrowable(worldIn)
{
}

EntityExpBottle::EntityExpBottle(World *worldIn, EntityLivingBase *throwerIn) : EntityThrowable(worldIn, throwerIn)
{
}

EntityExpBottle::EntityExpBottle(World *worldIn, double x, double y, double z) : EntityThrowable(worldIn, x, y, z)
{
}
