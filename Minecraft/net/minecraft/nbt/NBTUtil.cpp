...
std::shared_ptr<NBTTagCompound> NBTUtil::writeGameProfile(NBTTagCompound tagCompound, GameProfile profile)
{
    ...
    if (!profile.getProperties().isEmpty())
    {
        ...
        while (var3.hasNext())
        {
            ...
            for (Iterator var6 = profile.getProperties().get(s).iterator(); var6.hasNext();
...
IBlockState NBTUtil::setValueHelper(IBlockState p_193590_0_, IProperty p_193590_1_, std::string p_193590_2_,
                                    std::shared_ptr<NBTTagCompound> p_193590_3_,
                                    std::shared_ptr<NBTTagCompound> p_193590_4_)
{
    ...
    {
        LOGGER->warn("Unable to read property: {} with value: {} for blockstate: {}", p_193590_2_,
                     p_193590_3_->getString(p_193590_2_), p_193590_4_->to_string());
        return p_193590_0_;
    }
}
