...
public:
  ...
  void affectEntity(Entity* source,Entity* indirectSource, EntityLivingBase* entityLivingBaseIn, int32_t amplifier, double health);
  ...
  Potion& registerPotionAttributeModifier(IAttribute* attribute, std::string_view uniqueId, double ammount, int32_t operation);
  ...
  void applyAttributesModifiersToEntity(EntityLivingBase* entityLivingBaseIn, AbstractAttributeMap attributeMapIn, int32_t amplifier);
