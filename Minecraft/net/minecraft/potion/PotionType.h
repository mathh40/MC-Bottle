...
ResourceLocation EMPTY = ResourceLocation("empty");

class PotionType
{
public:
  static inline RegistryNamespacedDefaultedByKey<ResourceLocation,PotionType> REGISTRY = RegistryNamespacedDefaultedByKey<ResourceLocation,PotionType>(EMPTY);
