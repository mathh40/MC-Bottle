...
bool PotionHelper::isReagent(ItemStack stack)
{
  return isItemConversionReagent(stack) || isTypeConversionReagent(stack);
}

ItemStack PotionHelper::doReaction(ItemStack reagent, ItemStack potionIn)
{
  if (!potionIn.isEmpty()) 
  {
    ...
    for(k = POTION_ITEM_CONVERSIONS.size(); i < k; ++i) {
      ...
      {
        return PotionUtils.addPotionToItemStack(ItemStack((Item)mixpredicate1.output), potiontype);
      }
    }
    ...
    for(k = POTION_TYPE_CONVERSIONS.size(); i < k; ++i) {
      ...
      {
        return PotionUtils.addPotionToItemStack(ItemStack(item), (PotionType)mixpredicate1.output);
      }
    }
  }
...
bool PotionHelper::isItemConversionReagent(ItemStack stack)
{
  int32_t i = 0;

  for(auto j = POTION_ITEM_CONVERSIONS.size(); i < j; ++i) 
  {
...
bool PotionHelper::isTypeConversionReagent(ItemStack stack)
{
  int32_t i = 0;
...
bool PotionHelper::hasConversions(ItemStack input, ItemStack reagent)
{
...
bool PotionHelper::hasItemConversions(ItemStack input, ItemStack reagent)
{
...
bool PotionHelper::hasTypeConversions(ItemStack input, ItemStack reagent)
{
...
void PotionHelper::addContainerRecipe(ItemPotion p_193355_0_, Item p_193355_1_, ItemPotion p_193355_2_)
{
  POTION_ITEM_CONVERSIONS.add(PotionHelper::MixPredicate(p_193355_0_, Ingredient::fromItems(p_193355_1_), p_193355_2_));
}

void PotionHelper::addContainer(ItemPotion p_193354_0_)
{
  POTION_ITEMS.add(Ingredient::fromItems(p_193354_0_));
}

void PotionHelper::addMix(PotionType p_193357_0_, Item p_193357_1_, PotionType p_193357_2_)
{
  addMix(p_193357_0_, Ingredient::fromItems(p_193357_1_), p_193357_2_);
}

void PotionHelper::addMix(PotionType p_193356_0_, Ingredient p_193356_1_, PotionType p_193356_2_)
{
   POTION_TYPE_CONVERSIONS.add(PotionHelper::MixPredicate(p_193356_0_, p_193356_1_, p_193356_2_));
}
