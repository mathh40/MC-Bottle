...
class Item
{
  public:
    ...
    virtual EnumActionResult onItemUse(EntityPlayer *player, World *worldIn, BlockPos pos, EnumHand hand,
    ...
    virtual bool onBlockDestroyed(ItemStack stack, World *worldIn, IBlockState *state, BlockPos pos,
                                  EntityLivingBase *entityLiving);
    virtual bool canHarvestBlock(IBlockState *blockIn);
    virtual bool itemInteractionForEntity(ItemStack stack, EntityPlayer *playerIn, EntityLivingBase *target,
                                          EnumHand hand);
    Item *setFull3D();
    ...
    virtual void onPlayerStoppedUsing(ItemStack stack, World *worldIn, EntityLivingBase *entityLiving,
                                      int32_t timeLeft);
    virtual void addInformation(ItemStack stack, World *worldIn, std::vector<std::string> &tooltip,
                                ITooltipFlag *flagIn);
    ...
    virtual std::unordered_multimap<std::string, AttributeModifier> getItemAttributeModifiers(
