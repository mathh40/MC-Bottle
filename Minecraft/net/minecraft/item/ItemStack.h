...
class ItemStack
{
  public:
    ...
    Item *getItem() const;
    EnumActionResult onItemUse(EntityPlayer *playerIn, World *worldIn, BlockPos pos, EnumHand hand, EnumFacing side,
    ...
    std::unordered_multimap<std::string, AttributeModifier> getAttributeModifiers(
        EntityEquipmentSlot equipmentSlot) const;
    void addAttributeModifier(std::string_view attributeName, AttributeModifier modifier,
