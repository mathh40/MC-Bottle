...
class ItemArmor : public Item
{
  public:
    ...
    static constexpr std::array<const char *, 4> EMPTY_SLOT_NAMES = {
        "minecraft:items/empty_armor_slot_boots", "minecraft:items/empty_armor_slot_leggings",
        "minecraft:items/empty_armor_slot_chestplate", "minecraft:items/empty_armor_slot_helmet"};
