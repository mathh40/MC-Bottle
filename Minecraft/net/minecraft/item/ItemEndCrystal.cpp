    ...
    EnumFacing facing, float hitX, float hitY, float hitZ)
{
    ...
    else 
    {
        ...
        else 
        {
            ...
            bool flag = !worldIn->isAirBlock(blockpos) && !worldIn->getBlockState(blockpos).getBlock().isReplaceable(worldIn, blockpos);
            ...
            else 
            {
                ...
                else 
                {
                    if (!worldIn->isRemote) 
                    {
                        EntityEnderCrystal entityendercrystal = EntityEnderCrystal(worldIn, (double)((float)pos.getx() + 0.5F), (double)(pos.gety() + 1), (double)((float)pos.getz() + 0.5F));
