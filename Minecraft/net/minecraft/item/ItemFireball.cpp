                                         ...
                                         EnumFacing facing, float hitX, float hitY, float hitZ)
{
    ...
    else
    {
        ...
        else
        {
            ...
            {
                worldIn->playSound(nullptr, pos, SoundEvents::ITEM_FIRECHARGE_USE, SoundCategory::BLOCKS, 1.0F,
                                   (MathHelper::nextFloat(itemRand) - MathHelper::nextFloat(itemRand)) * 0.2F + 1.0F);
