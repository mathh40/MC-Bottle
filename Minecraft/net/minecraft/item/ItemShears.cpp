    ...
    EntityLivingBase *entityLiving)
{
    ...
    return state->getMaterial() != Material::LEAVES && block != Blocks::WEB && block != Blocks::TALLGRASS && block != Blocks::VINE && block != Blocks::TRIPWIRE && block != Blocks::WOOL ? Item::onBlockDestroyed(stack, worldIn, state, pos, entityLiving) : true;
}
