...
ItemLilyPad::ItemLilyPad(Block *block) : ItemColored(block, false)
{
}
    ...
    else
    {
        if (raytraceresult.typeOfHit == RayTraceResult::Type::BLOCK)
        {
                ...
                worldIn->isAirBlock(blockpos1))
            {
                ...
                worldIn->playSound(playerIn, blockpos, SoundEvents::BLOCK_WATERLILY_PLACE, SoundCategory::BLOCKS, 1.0F,
                                   1.0F);
