...
public:
    CommandResultStats();
    void setCommandStatForSender(MinecraftServer* server, ICommandSender* sender, const CommandResultStatsType& typeIn, int32_t p_184932_4_);
    void readStatsFromNBT(NBTTagCompound* tagcompound);
    void writeStatsToNBT(NBTTagCompound* tagcompound);
    static void setScoreBoardStat(CommandResultStats stats, const CommandResultStatsType& resultType, std::optional<std::string_view> entityID, std::optional<std::string_view> objectiveName);
