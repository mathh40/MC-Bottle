...
DifficultyInstance::DifficultyInstance(EnumDifficulty worldDifficulty, int64_t worldTime, int64_t chunkInhabitedTime, float moonPhaseFactor)
	:worldDifficulty(worldDifficulty), additionalDifficulty(calculateAdditionalDifficulty(worldDifficulty, worldTime, chunkInhabitedTime, moonPhaseFactor))
{
}
...
float DifficultyInstance::calculateAdditionalDifficulty(EnumDifficulty difficulty, int64_t worldTime, int64_t chunkInhabitedTime, float moonPhaseFactor)
{
