...
std::optional<BlockPos> ChunkGeneratorHell::getNearestStructurePos(World* worldIn, std::string_view structureName, BlockPos& position,
	bool findUnexplored)
{
	return "Fortress" == structureName ? genNetherBridge.getNearestStructurePos(worldIn, position, findUnexplored) : std::nullopt;
}
...
void ChunkGeneratorHell::buildSurfaces(int32_t p_185937_1_, int32_t p_185937_2_, ChunkPrimer& primer)
{
	...
	auto d0 = 0.03125;
	slowsandNoise = slowsandGravelNoiseGen.generateNoiseOctaves(slowsandNoise, p_185937_1_ * 16, p_185937_2_ * 16, 0, 16, 16, 1, 0.03125, 0.03125, 1.0);
	gravelNoise = slowsandGravelNoiseGen.generateNoiseOctaves(gravelNoise, p_185937_1_ * 16, 109, p_185937_2_ * 16, 16, 1, 16, 0.03125, 1.0, 0.03125);
	depthBuffer = netherrackExculsivityNoiseGen.generateNoiseOctaves(depthBuffer, p_185937_1_ * 16, p_185937_2_ * 16, 0, 16, 16, 1, 0.0625, 0.0625, 0.0625);
...
std::vector<double> ChunkGeneratorHell::getHeights(std::vector<double>& p_185938_1_, int32_t p_185938_2_,
	int32_t p_185938_3_, int32_t p_185938_4_, int32_t p_185938_5_, int32_t p_185938_6_, int32_t p_185938_7_)
{
	...
	auto d0 = 684.412;
	auto d1 = 2053.236;
	noiseData4 = scaleNoise.generateNoiseOctaves(noiseData4, p_185938_2_, p_185938_3_, p_185938_4_, p_185938_5_, 1, p_185938_7_, 1.0, 0.0, 1.0);
	dr = depthNoise.generateNoiseOctaves(dr, p_185938_2_, p_185938_3_, p_185938_4_, p_185938_5_, 1, p_185938_7_, 100.0, 0.0, 100.0);
	pnr = perlinNoise1.generateNoiseOctaves(pnr, p_185938_2_, p_185938_3_, p_185938_4_, p_185938_5_, p_185938_6_, p_185938_7_, 8.555150000000001, 34.2206, 8.555150000000001);
	ar = lperlinNoise1.generateNoiseOctaves(ar, p_185938_2_, p_185938_3_, p_185938_4_, p_185938_5_, p_185938_6_, p_185938_7_, 684.412, 2053.236, 684.412);
	br = lperlinNoise2.generateNoiseOctaves(br, p_185938_2_, p_185938_3_, p_185938_4_, p_185938_5_, p_185938_6_, p_185938_7_, 684.412, 2053.236, 684.412);
	auto i = 0;
