...
class ChunkGeneratorEnd : public IChunkGenerator
{
  public:
    ...
    std::optional<BlockPos> getNearestStructurePos(World *var1, std::string_view var2, BlockPos &var3,
                                                   bool var4) override;
  ...
  private:
    ...
    std::vector<double> getHeights(std::vector<double> &p_185963_1_, int32_t p_185963_2_, int32_t p_185963_3_,
                                   int32_t p_185963_4_, int32_t p_185963_5_, int32_t p_185963_6_, int32_t p_185963_7_);
};
