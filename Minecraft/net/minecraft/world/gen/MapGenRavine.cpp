...
void MapGenRavine::addTunnel(int64_t p_180707_1_, int32_t p_180707_3_, int32_t p_180707_4_, ChunkPrimer &p_180707_5_,
                             double p_180707_6_, double p_180707_8_, double p_180707_10_, float p_180707_12_,
                             float p_180707_13_, float p_180707_14_, int32_t p_180707_15_, int32_t p_180707_16_,
                             double p_180707_17_)
{
    ...
    {
        auto d9 =
            1.5 + (double)(MathHelper::sin((float)p_180707_15_ * 3.1415927F / (float)p_180707_16_) * p_180707_12_);
        ...
        if (flag1 || random(4) != 0)
        {
            ...
            if (p_180707_6_ >= d0 - 16.0 - d9 * 2.0 && p_180707_10_ >= d1 - 16.0 - d9 * 2.0 &&
                p_180707_6_ <= d0 + 16.0 + d9 * 2.0 && p_180707_10_ <= d1 + 16.0 + d9 * 2.0)
            {
                                    ...
                                    if ((d10 * d10 + d7 * d7) * (double)rs[j2 - 1] + d8 * d8 / 6.0 < 1.0)
                                    {
                                            ...
                                            iblockstate1.getBlock() == Blocks::GRASS)
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                if (flag && p_180707_5_->getBlockState(j3, j2 - 1, i2).getBlock() ==
                                                                Blocks::DIRT)
                                                {
                                                    ...
                                                    p_180707_5_->setBlockState(
                                                        j3, j2 - 1, i2,
                                                        world->getBiome(blockpos$mutableblockpos).topBlock);
                                                }
                                            }
                                        }
                                    }
