...
WorldGenLakes::WorldGenLakes(Block *blockIn) : block(blockIn)
{
}
    ...
    else
    {
        ...
        for (auto k2 = 0; k2 < 16; ++k2)
        {
            for (auto l3 = 0; l3 < 16; ++l3)
            {
                ...
                {
                    auto flag1 =
                        !aboolean[(k2 * 16 + l3) * 8 + k4] && (k2 < 15 && aboolean[((k2 + 1) * 16 + l3) * 8 + k4] ||
                                                               k2 > 0 && aboolean[((k2 - 1) * 16 + l3) * 8 + k4] ||
                                                               l3 < 15 && aboolean[(k2 * 16 + l3 + 1) * 8 + k4] ||
                                                               l3 > 0 && aboolean[(k2 * 16 + (l3 - 1)) * 8 + k4] ||
                                                               k4 < 7 && aboolean[(k2 * 16 + l3) * 8 + k4 + 1] ||
                                                               k4 > 0 && aboolean[(k2 * 16 + l3) * 8 + (k4 - 1)]);
                    if (flag1)
                    {
                        ...
                        if (k4 < 4 && !material.isSolid() &&
                            worldIn->getBlockState(position.add(k2, k4, l3))->getBlock() != block)
                        {
                            return false;
                        }
                    }
        ...
        for (auto k2 = 0; k2 < 16; ++k2)
        {
            for (auto l3 = 0; l3 < 16; ++l3)
            {
                for (auto k4 = 0; k4 < 8; ++k4)
                {
                    ...
                    {
                        worldIn->setBlockState(position.add(k2, k4, l3),
                                               k4 >= 4 ? Blocks::AIR.getDefaultState() : block->getDefaultState(), 2);
                    }
                }
            }
        }
                ...
                for (auto k4 = 4; k4 < 8; ++k4)
                {
                    if (aboolean[(k2 * 16 + l3) * 8 + k4])
                    {
                        ...
                        if (worldIn->getBlockState(blockpos).getBlock() == Blocks::DIRT &&
                            worldIn->getLightFor(EnumSkyBlock::SKY, position.add(k2, k4, l3)) > 0)
                        {
                    ...
                    for (auto k4 = 0; k4 < 8; ++k4)
                    {
                        auto flag1 =
                            !aboolean[(k2 * 16 + l3) * 8 + k4] && (k2 < 15 && aboolean[((k2 + 1) * 16 + l3) * 8 + k4] ||
                                                                   ...
                                                                   k4 < 7 && aboolean[(k2 * 16 + l3) * 8 + k4 + 1] ||
                                                                   k4 > 0 && aboolean[(k2 * 16 + l3) * 8 + (k4 - 1)]);
                        if (flag1 && (k4 < 4 || rand(2) != 0) &&
                            worldIn->getBlockState(position.add(k2, k4, l3))->getMaterial().isSolid())
                        {
