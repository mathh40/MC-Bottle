...
std::array<ResourceLocation, 8> WorldGenFossils::FOSSILS{ STRUCTURE_SPINE_01, STRUCTURE_SPINE_02, STRUCTURE_SPINE_03, STRUCTURE_SPINE_04, STRUCTURE_SKULL_01, STRUCTURE_SKULL_02, STRUCTURE_SKULL_03, STRUCTURE_SKULL_04 };
std::array<ResourceLocation, 8> WorldGenFossils::FOSSILS_COAL{ STRUCTURE_SPINE_01_COAL, STRUCTURE_SPINE_02_COAL, STRUCTURE_SPINE_03_COAL, STRUCTURE_SPINE_04_COAL, STRUCTURE_SKULL_01_COAL, STRUCTURE_SKULL_02_COAL, STRUCTURE_SKULL_03_COAL, STRUCTURE_SKULL_04_COAL };
...
bool WorldGenFossils::generate(World* worldIn, pcg32& rand, const BlockPos& position)
{
	...
	auto structureboundingbox(chunkpos.getXStart(), 0, chunkpos.getZStart(), chunkpos.getXEnd(), 256, chunkpos.getZEnd());
	auto placementsettings = ( PlacementSettings()).setRotation(rotation).setBoundingBox(structureboundingbox).setRandom(random);
