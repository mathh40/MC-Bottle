...
IBlockState* WorldGenSavannaTree::TRUNK = Blocks::LOG2.getDefaultState().withProperty(BlockNewLog.VARIANT, BlockPlanks.EnumType.ACACIA);
IBlockState* WorldGenSavannaTree::LEAF = Blocks::LEAVES2.getDefaultState().withProperty(BlockNewLeaf.VARIANT, BlockPlanks.EnumType.ACACIA).withProperty(BlockLeaves.CHECK_DECAY, false);

WorldGenSavannaTree::WorldGenSavannaTree(bool doBlockNotify)
	:WorldGenAbstractTree(doBlockNotify)
{
}
