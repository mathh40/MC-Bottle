...
BlockStateMatcher WorldGenDesertWells::IS_SAND =
    BlockStateMatcher.forBlock(Blocks.SAND).where(BlockSand.VARIANT, Predicates.equalTo(BlockSand.EnumType.SAND));

WorldGenDesertWells::WorldGenDesertWells()
    : sandSlab(Blocks.STONE_SLAB.getDefaultState()
      ...
      sandstone(Blocks.SANDSTONE.getDefaultState()), water(Blocks.FLOWING_WATER.getDefaultState())
{
}
