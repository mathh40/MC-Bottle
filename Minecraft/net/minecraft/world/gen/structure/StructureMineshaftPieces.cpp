...
bool StructureMineshaftPieces::Peice::isSupportingBox(World* p_189918_1_, StructureBoundingBox p_189918_2_,
   int32_t p_189918_3_, int32_t p_189918_4_, int32_t p_189918_5_, int32_t p_189918_6_)
{
   ...
   int32_t y, int32_t z, EnumFacing facing)
{
   ...
   return StructureComponent::findIntersecting(listIn, structureboundingbox) != nullptr ? std::nullopt : structureboundingbox;
}
   ...
   :StructureMineshaftPieces::Peice(p_i47137_1_, p_i47137_5_)
{
   ...
   boundingBox = StructureBoundingBox(p_i47137_3_, 50, p_i47137_4_, p_i47137_3_ + 7 + p_i47137_2_(6), 54 + p_i47137_2_(6), p_i47137_4_ + 7 + p_i47137_2_(6));
}
...
void StructureMineshaftPieces::Room::buildComponent(StructureComponent* componentIn, std::vector<> listIn, pcg32& rand)
{
   ...
   for(k = 0; k < boundingBox.getXSize(); k += 4) 
   {
      ...
      structurecomponent = StructureMineshaftPieces::generateAndAddPiece(componentIn, listIn, rand, boundingBox.minX + k, boundingBox.minY + rand(j) + 1, boundingBox.minZ - 1, EnumFacing::NORTH, i);
      if (structurecomponent != nullptr) 
      {
         structureboundingbox3 = structurecomponent->getBoundingBox();
         connectedRooms.add(new StructureBoundingBox(structureboundingbox3.minX, structureboundingbox3.minY, boundingBox.minZ, structureboundingbox3.maxX, structureboundingbox3.maxY, boundingBox.minZ + 1));
      }
   }
   ...
   for(k = 0; k < boundingBox.getXSize(); k += 4) 
   {
      ...
      structurecomponent = StructureMineshaftPieces::generateAndAddPiece(componentIn, listIn, rand, boundingBox.minX + k, boundingBox.minY + rand(j) + 1, boundingBox.maxZ + 1, EnumFacing::SOUTH, i);
      if (structurecomponent != nullptr) 
      {
         structureboundingbox3 = structurecomponent->getBoundingBox();
         connectedRooms.add(StructureBoundingBox(structureboundingbox3.minX, structureboundingbox3.minY, boundingBox.maxZ - 1, structureboundingbox3.maxX, structureboundingbox3.maxY, boundingBox.maxZ));
      }
   }
   ...
   for(k = 0; k < boundingBox.getZSize(); k += 4) 
   {
      ...
      structurecomponent = StructureMineshaftPieces::generateAndAddPiece(componentIn, listIn, rand, boundingBox.minX - 1, boundingBox.minY + rand(j) + 1, boundingBox.minZ + k, EnumFacing::WEST, i);
      if (structurecomponent != nullptr) 
      {
         structureboundingbox3 = structurecomponent->getBoundingBox();
         connectedRooms.add(StructureBoundingBox(boundingBox.minX, structureboundingbox3.minY, structureboundingbox3.minZ, boundingBox.minX + 1, structureboundingbox3.maxY, structureboundingbox3.maxZ));
      }
   }
   ...
   for(k = 0; k < boundingBox.getZSize(); k += 4) 
   {
      ...
      structurecomponent = StructureMineshaftPieces::generateAndAddPiece(componentIn, listIn, rand, boundingBox.maxX + 1, boundingBox.minY + rand(j) + 1, boundingBox.minZ + k, EnumFacing::EAST, i);
      if (structurecomponent != nullptr) 
      {
         structureboundingbox3 = structurecomponent->getBoundingBox();
         connectedRooms.add(StructureBoundingBox(boundingBox.maxX - 1, structureboundingbox3.minY, structureboundingbox3.minZ, boundingBox.maxX, structureboundingbox3.maxY, structureboundingbox3.maxZ));
      }
   }
}
   ...
   StructureBoundingBox structureBoundingBoxIn)
{
   ...
   else 
   {
      ...
      fillWithBlocks(worldIn, structureBoundingBoxIn, boundingBox.minX, boundingBox.minY + 1, boundingBox.minZ, boundingBox.maxX, MathHelper::min(boundingBox.minY + 3, boundingBox.maxY), boundingBox.maxZ, Blocks::AIR.getDefaultState(), Blocks::AIR.getDefaultState(), false);
...
std::optional<StructureBoundingBox> StructureMineshaftPieces::Cross::findCrossing(std::vector<> listIn, pcg32& rand, int32_t x,
   int32_t y, int32_t z, EnumFacing facing)
{
...
void StructureMineshaftPieces::Cross::placeSupportPillar(World* p_189923_1_, StructureBoundingBox p_189923_2_,
   int32_t p_189923_3_, int32_t p_189923_4_, int32_t p_189923_5_, int32_t p_189923_6_)
{
...
std::optional<StructureBoundingBox> StructureMineshaftPieces::Corridor::findCorridorSize(std::vector<> p_175814_0_, pcg32& rand,
   int32_t x, int32_t y, int32_t z, EnumFacing facing)
{
   StructureBoundingBox structureboundingbox(x, y, z, x, y + 2, z);
   int32_t i = 0;
   ...
   pcg32& rand)
{
   ...
   EnumFacing enumfacing = getCoordBaseMode();
   {
      ...
      default:
         if (j <= 1) 
         {
            StructureMineshaftPieces::generateAndAddPiece(componentIn, listIn, rand, boundingBox.minX, boundingBox.minY - 1 + rand(3), boundingBox.minZ - 1, enumfacing, i);
         }
         else if (j == 2) 
         {
            StructureMineshaftPieces::generateAndAddPiece(componentIn, listIn, rand, boundingBox.minX - 1, boundingBox.minY - 1 + rand(3), boundingBox.minZ, EnumFacing::WEST, i);
         }
         else 
         {
            StructureMineshaftPieces::generateAndAddPiece(componentIn, listIn, rand, boundingBox.maxX + 1, boundingBox.minY - 1 + rand(3), boundingBox.minZ, EnumFacing::EAST, i);
         }
         break;
      case EnumFacing::SOUTH:
         if (j <= 1) 
         {
            StructureMineshaftPieces::generateAndAddPiece(componentIn, listIn, rand, boundingBox.minX, boundingBox.minY - 1 + rand(3), boundingBox.maxZ + 1, enumfacing, i);
         }
         else if (j == 2) 
         {
            StructureMineshaftPieces::generateAndAddPiece(componentIn, listIn, rand, boundingBox.minX - 1, boundingBox.minY - 1 + rand(3), boundingBox.maxZ - 3, EnumFacing::WEST, i);
         }
         else 
         {
            StructureMineshaftPieces::generateAndAddPiece(componentIn, listIn, rand, boundingBox.maxX + 1, boundingBox.minY - 1 + rand(3), boundingBox.maxZ - 3, EnumFacing::EAST, i);
         }
         break;
      case EnumFacing::WEST:
         if (j <= 1) 
         {
            StructureMineshaftPieces::generateAndAddPiece(componentIn, listIn, rand, boundingBox.minX - 1, boundingBox.minY - 1 + rand(3), boundingBox.minZ, enumfacing, i);
         }
         else if (j == 2) 
         {
            StructureMineshaftPieces::generateAndAddPiece(componentIn, listIn, rand, boundingBox.minX, boundingBox.minY - 1 + rand(3), boundingBox.minZ - 1, EnumFacing::NORTH, i);
         }
         else 
         {
            StructureMineshaftPieces::generateAndAddPiece(componentIn, listIn, rand, boundingBox.minX, boundingBox.minY - 1 + rand(3), boundingBox.maxZ + 1, EnumFacing::SOUTH, i);
         }
         break;
      case EnumFacing::EAST:
         if (j <= 1) 
         {
            StructureMineshaftPieces::generateAndAddPiece(componentIn, listIn, rand, boundingBox.maxX + 1, boundingBox.minY - 1 + rand(3), boundingBox.minZ, enumfacing, i);
         }
         else if (j == 2) 
         {
            StructureMineshaftPieces::generateAndAddPiece(componentIn, listIn, rand, boundingBox.maxX - 3, boundingBox.minY - 1 + rand(3), boundingBox.minZ - 1, EnumFacing::NORTH, i);
         }
         else 
         {
            StructureMineshaftPieces::generateAndAddPiece(componentIn, listIn, rand, boundingBox.maxX - 3, boundingBox.minY - 1 + rand(3), boundingBox.maxZ + 1, EnumFacing::SOUTH, i);
         }
      }
      ...
      if (i < 8) 
      {
         ...
         if (enumfacing != EnumFacing::NORTH && enumfacing != EnumFacing::SOUTH) 
         {
            for(k = boundingBox.minX + 3; k + 3 <= boundingBox.maxX; k += 5) 
            {
               ...
               if (l == 0) 
               {
                  StructureMineshaftPieces::generateAndAddPiece(componentIn, listIn, rand, k, boundingBox.minY, boundingBox.minZ - 1, EnumFacing::NORTH, i + 1);
               }
               else if (l == 1) 
               {
                  StructureMineshaftPieces::generateAndAddPiece(componentIn, listIn, rand, k, boundingBox.minY, boundingBox.maxZ + 1, EnumFacing::SOUTH, i + 1);
               }
            }
         }
         else 
   ...
   StructureBoundingBox structureBoundingBoxIn)
{
   ...
   else 
   {
      ...
      for(auto l2 = 0; l2 < sectionCount; ++l2) 
      {
         ...
         if (randomIn(100) == 0) 
         {
            generateChest(worldIn, structureBoundingBoxIn, randomIn, 2, 0, j3 - 1, LootTableList.CHESTS_ABANDONED_MINESHAFT);
         }

         if (randomIn(100) == 0) 
         {
            generateChest(worldIn, structureBoundingBoxIn, randomIn, 0, 0, j3 + 1, LootTableList.CHESTS_ABANDONED_MINESHAFT);
         }
      ...
      for(auto l2 = 0; l2 <= 2; ++l2) 
      {
         for(auto j3 = 0; j3 <= i1; ++j3) 
         {
            ...
            if (iblockstate3->getMaterial() == Material::AIR && getSkyBrightness(worldIn, l2, -1, j3, structureBoundingBoxIn) < 8) 
            {
...
void StructureMineshaftPieces::Corridor::placeSupport(World* p_189921_1_, StructureBoundingBox p_189921_2_,
   int32_t p_189921_3_, int32_t p_189921_4_, int32_t p_189921_5_, int32_t p_189921_6_, int32_t p_189921_7_,
   pcg32& p_189921_8_)
{
...
std::unique_ptr<StructureMineshaftPieces::Peice> StructureMineshaftPieces::createRandomShaftPiece(std::vector<> p_189940_0_,
                                                                                                  pcg32& p_189940_1_, int32_t p_189940_2_, int32_t p_189940_3_, int32_t p_189940_4_,
                                                                                                  std::optional<EnumFacing> p_189940_5_, int32_t p_189940_6_, MapGenMineshaft::Type p_189940_7_)
{
   ...
   if (i >= 80) 
   {
      ...
      {
         return std::make_unique<StructureMineshaftPieces::Cross>(p_189940_6_, p_189940_1_, structureboundingbox1, p_189940_5_, p_189940_7_);
      }
   } else if (i >= 70) 
   {
      ...
      if (structureboundingbox1 != std::nullopt) 
      {
         return std::make_unique<StructureMineshaftPieces::Stairs>(p_189940_6_, p_189940_1_, structureboundingbox1, p_189940_5_, p_189940_7_);
      }
   }
   else 
   {
      ...
      if (structureboundingbox1 != std::nullopt) 
      {
         return std::make_unique<StructureMineshaftPieces::Corridor>(p_189940_6_, p_189940_1_, structureboundingbox1, p_189940_5_, p_189940_7_);
      }
   }
   ...
   int32_t p_189938_4_, int32_t p_189938_5_, EnumFacing p_189938_6_, int32_t p_189938_7_)
{
   ...
   else if (MathHelper::abs(p_189938_3_ - p_189938_0_->getBoundingBox().minX) <= 80 && MathHelper::abs(p_189938_5_ - p_189938_0_->getBoundingBox().minZ) <= 80) 
   {
      auto mapgenmineshaft$type = ((StructureMineshaftPieces::Peice)p_189938_0_)->mineShaftType;
      auto structuremineshaftpieces$peice = createRandomShaftPiece(p_189938_1_, p_189938_2_, p_189938_3_, p_189938_4_, p_189938_5_, p_189938_6_, p_189938_7_ + 1, mapgenmineshaft$type);
...
bool StructureMineshaftPieces::Corridor::generateChest(World* worldIn, StructureBoundingBox structurebb,
   pcg32& randomIn, int32_t x, int32_t y, int32_t z, ResourceLocation loot)
{
