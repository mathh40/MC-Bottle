...
public:
	...
	static StructureBoundingBox getComponentToAddBoundingBox(int32_t structureMinX, int32_t structureMinY, int32_t structureMinZ, int32_t xMin, int yMin, int32_t zMin, int32_t xMax, int32_t yMax, int32_t zMax, EnumFacing facing);
