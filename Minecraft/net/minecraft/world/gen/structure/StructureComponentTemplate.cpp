...
StructureComponentTemplate::StructureComponentTemplate(int32_t type)
...
{
	templatePosition = BlockPos(tagCompound->getInteger("TPX"), tagCompound->getInteger("TPY"), tagCompound->getInteger("TPZ"));
}
