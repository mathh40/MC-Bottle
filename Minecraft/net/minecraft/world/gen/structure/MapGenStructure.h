...
class MapGenStructure : public MapGenBase
{
  ...
  protected:
    ...
    std::optional<BlockPos> findNearestStructurePosBySpacing(World *worldIn, MapGenStructure &structureType,
                                                             BlockPos &startPos, int32_t distanceStep,
                                                             int32_t stepOffset, int32_t randomSeedZ,
                                                             bool addExtraRandomness, int32_t maxAttempts,
                                                             bool findUnexplored);
