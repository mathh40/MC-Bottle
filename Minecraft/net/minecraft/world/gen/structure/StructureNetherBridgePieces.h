...
class StructureNetherBridgePieces
{
  ...
  private:
    static const StructureNetherBridgePieces::PieceWeight PRIMARY_COMPONENTS[] =
    ...
    static const StructureNetherBridgePieces::PieceWeight SECONDARY_COMPONENTS[] =
        new StructureNetherBridgePieces.PieceWeight[]{
    ...
    StructureNetherBridgePieces::Piece findAndCreateBridgePieceFactory(
