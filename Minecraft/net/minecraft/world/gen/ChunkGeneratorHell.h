...
private:
	...
	std::vector<double> getHeights(std::vector<double>& p_185938_1_, int32_t p_185938_2_, int32_t p_185938_3_, int32_t p_185938_4_, int32_t p_185938_5_, int32_t p_185938_6_, int32_t p_185938_7_);
};
