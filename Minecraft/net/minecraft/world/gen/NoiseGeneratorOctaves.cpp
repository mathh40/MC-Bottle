...
std::vector<double> NoiseGeneratorOctaves::generateNoiseOctaves(std::vector<double>& noiseArray, int32_t xOffset,
	int32_t yOffset, int32_t zOffset, int32_t xSize, int32_t ySize, int32_t zSize, double xScale, double yScale,
	double zScale)
{
	if (noiseArray.empty()) 
	{
...
std::vector<double> NoiseGeneratorOctaves::generateNoiseOctaves(std::vector<double>& noiseArray, int32_t xOffset,
	int32_t zOffset, int32_t xSize, int32_t zSize, double xScale, double zScale, double p_76305_10_)
{
