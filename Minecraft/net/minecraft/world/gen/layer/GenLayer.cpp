...
std::vector<std::shared_ptr<GenLayer>> GenLayer::initializeAllBiomeGenerators(int64_t seed, WorldType p_180781_2_,
	std::optional<ChunkGeneratorSettings> p_180781_3_)
{
