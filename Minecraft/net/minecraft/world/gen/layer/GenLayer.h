...
class GenLayer
{
  public:
    ...
    std::vector<std::shared_ptr<GenLayer>> initializeAllBiomeGenerators(
  ...
  protected:
    ...
    virtual int32_t selectModeOrRandom(int32_t p_151617_1_, int32_t p_151617_2_, int32_t p_151617_3_,
                                       int32_t p_151617_4_);
