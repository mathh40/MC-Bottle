...
{
	auto warmBiomes = { Biomes::DESERT, Biomes::DESERT, Biomes::DESERT, Biomes::SAVANNA, Biomes::SAVANNA, Biomes::PLAINS };
	auto mediumBiomes = { Biomes::FOREST, Biomes::ROOFED_FOREST, Biomes::EXTREME_HILLS, Biomes::PLAINS, Biomes::BIRCH_FOREST, Biomes::SWAMPLAND };
	...
	{
		warmBiomes = { Biomes::DESERT, Biomes::FOREST, Biomes::EXTREME_HILLS, Biomes::SWAMPLAND, Biomes::PLAINS, Biomes::TAIGA };
