...
public:
	...
	Explosion newExplosion(Entity* entityIn, double x, double y, double z, float strength, bool causesFire, bool damagesTerrain) override;
	...
	void spawnParticle(EnumParticleTypes particleType, double xCoord, double yCoord, double zCoord, int32_t numberOfParticles, double xOffset, double yOffset, double zOffset, double particleSpeed, std::initializer_list<int32_t> particleArguments);
	void spawnParticle(EnumParticleTypes particleType, bool longDistance, double xCoord, double yCoord, double zCoord, int32_t numberOfParticles, double xOffset, double yOffset, double zOffset, double particleSpeed, std::initializer_list<int32_t> particleArguments);
	void spawnParticle(EntityPlayerMP* player, EnumParticleTypes particle, bool longDistance, double x, double y, double z, int32_t count, double xOffset, double yOffset, double zOffset, double speed, std::initializer_list<int32_t> particleArguments);
...
private:
	...
	ServerBlockEventList[] blockEventQueue = new WorldServer.ServerBlockEventList[]{ new WorldServer.ServerBlockEventList(), new WorldServer.ServerBlockEventList() };
	...
	void sendPacketWithinDistance(EntityPlayerMP* player, bool longDistance, double x, double y, double z, Packet& packetIn);
}; 
