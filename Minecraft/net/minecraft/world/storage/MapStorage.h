...
{
  public:
    template <class T> std::unique_ptr<T> getOrLoadData(std::string_view dataIdentifier);
...
template <class T> std::unique_ptr<T> MapStorage::getOrLoadData(std::string_view dataIdentifier)
{
