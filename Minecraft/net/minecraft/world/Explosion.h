...
{
  public:
    Explosion(World *worldIn, Entity *entityIn, double x, double y, double z, float size,
              std::vector<BlockPos> affectedPositions);
    Explosion(World *worldIn, Entity *entityIn, double x, double y, double z, float size, bool causesFire,
              bool damagesTerrain, std::vector<BlockPos> affectedPositions);
    Explosion(World *worldIn, Entity *entityIn, double x, double y, double z, float size, bool causesFire,
              bool damagesTerrain);
