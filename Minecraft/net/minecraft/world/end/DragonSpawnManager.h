...
{
public:
	using processFunc = void(WorldServer* worldIn, DragonFightManager& manager, std::vector<EntityEnderCrystal*> crystals, int32_t ticks, BlockPos& pos);
	void process(WorldServer* worldIn, DragonFightManager& manager, std::vector<EntityEnderCrystal*> crystals, int32_t ticks, BlockPos& pos);
