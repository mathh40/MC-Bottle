...
{
public:
	int32_t findChunksForSpawning(WorldServer& worldServerIn, bool spawnHostileMobs, bool spawnPeacefulMobs, bool spawnOnSetTickRate);
	...
	void performWorldGenSpawning(World* worldIn, Biome& biomeIn, int32_t centerX, int32_t centerZ, int32_t diameterX, int32_t diameterZ, pcg32& randomIn);
private:
