...
BiomeSwamp::BiomeSwamp(BiomeProperties properties)
	:Biome(properties)
{
...
void BiomeSwamp::genTerrainBlocks(World* worldIn, pcg32& rand, ChunkPrimer chunkPrimerIn, int32_t x, int32_t z, double noiseVal)
{
