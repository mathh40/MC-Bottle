...
class Biome
{
  public:
    ...
    virtual void genTerrainBlocks(World *worldIn, Random &rand, ChunkPrimer chunkPrimerIn, int32_t x, int32_t z,
                                  double noiseVal);
    void generateBiomeTerrain(World *worldIn, Random &rand, ChunkPrimer chunkPrimerIn, int32_t x, int32_t z,
                              double noiseVal);
