...
class BiomeDecorator
{
  ...
  protected:
    ...
    virtual void genStandardOre1(World *worldIn, Random &random, int32_t blockCount, WorldGenerator *generator,
                                 int32_t minHeight, int32_t maxHeight);
    virtual void genStandardOre2(World *worldIn, Random &random, int32_t blockCount, WorldGenerator *generator,
