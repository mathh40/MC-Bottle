...
BiomeTaiga::BiomeTaiga(Type typeIn, BiomeProperties properties)
	:Biome(properties)
{
	type = typeIn;
...
{
	return rand(5) > 0 ? new WorldGenTallGrass(BlockTallGrass.EnumType.FERN) : new WorldGenTallGrass(BlockTallGrass.EnumType.GRASS);
}
...
void BiomeTaiga::genTerrainBlocks(World* worldIn, pcg32& rand, ChunkPrimer chunkPrimerIn, int32_t x, int32_t z, double noiseVal)
{
	if (type == Type::MEGA || type == Type::MEGA_SPRUCE) 
	{
