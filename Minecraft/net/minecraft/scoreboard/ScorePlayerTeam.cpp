...
ScorePlayerTeam::ScorePlayerTeam(Scoreboard *scoreboardIn, std::string_view name)
  :nameTagVisibility(EnumVisible::ALWAYS),deathMessageVisibility(EnumVisible::ALWAYS)
,color(TextFormatting::RESET),collisionRule(CollisionRule::ALWAYS),scoreboard(scoreboardIn),
