...
Team::EnumVisible::EnumVisible Team::EnumVisible::EnumVisible::HIDE_FOR_OTHER_TEAMS = Team::EnumVisible::EnumVisible("hideForOtherTeams", 2);
Team::EnumVisible::EnumVisible Team::EnumVisible::EnumVisible::HIDE_FOR_OWN_TEAM = Team::EnumVisible::EnumVisible("hideForOwnTeam", 3);
...
Team::CollisionRule Team::CollisionRule::getByName(std::string_view nameIn)
{
  ...
  Team::CollisionRule::CollisionRule(std::string_view nameIn, int32_t idIn)
:name(nameIn),id(idIn)
{
  nameMap.emplace(nameIn,this);
}
