...
private:
    const static std::array<EntityEquipmentSlot,4> VALID_EQUIPMENT_SLOTS = {EntityEquipmentSlot::HEAD, EntityEquipmentSlot::CHEST, EntityEquipmentSlot::LEGS, EntityEquipmentSlot::FEET};
    EntityPlayer* player;
};