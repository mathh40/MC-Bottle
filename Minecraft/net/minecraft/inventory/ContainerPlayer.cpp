...
{
  public:
    EquipmentSlot(const EntityEquipmentSlot *entityequipmentslot, IInventory *inventoryIn, int32_t index,
        ...
        else if (index >= 5 && index < 9)
        {
            if (!mergeItemStack(itemstack1, 9, 45, false))
            {
                return ItemStack::EMPTY;
                 ...
                 !(inventorySlots[8 - entityequipmentslot.getIndex()])->getHasStack())
        {
