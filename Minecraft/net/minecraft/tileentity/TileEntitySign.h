...
class TileEntitySign : public TileEntity
{
  public:
    ...
    {
      public:
        Command(TileEntitySign *entity) std::string getName()
        {
            return "Sign";
        }
        ...
        {
            return Vec3d((double)entity->pos.getx() + 0.5, (double)entity->pos.gety() + 0.5,
                         (double)entity->pos.getz() + 0.5);
        }
    ...
    ITextComponent *signText = new ITextComponent[]{TextComponentString(""), TextComponentString(""),
