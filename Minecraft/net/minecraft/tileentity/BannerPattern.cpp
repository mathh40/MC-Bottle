...
BannerPattern::BASE("base", "b"), BannerPattern::SQUARE_BOTTOM_LEFT("square_bottom_left", "bl", "   ", "   ", "#  "),
    ...
    BannerPattern::FLOWER("flower", "flo",
                          ItemStack(Blocks::RED_FLOWER, 1, BlockFlower::EnumFlowerType::OXEYE_DAISY.getMeta())),
