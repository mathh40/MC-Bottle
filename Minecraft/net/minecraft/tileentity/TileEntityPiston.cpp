...
TileEntityPiston::TileEntityPiston(IBlockState *pistonStateIn, EnumFacing pistonFacingIn, bool extendingIn,
    ...
    : pistonState(pistonStateIn), pistonFacing(pistonFacingIn), extending(extendingIn),
...
AxisAlignedBB TileEntityPiston::getAABB(IBlockAccess *p_184319_1_, BlockPos p_184319_2_, float p_184319_3_)
{
    ...
    return iblockstate->getBoundingBox(p_184319_1_, p_184319_2_)
        .offset((double)(p_184319_3_ * (float)pistonFacing.getXOffset()),
                (double)(p_184319_3_ * (float)pistonFacing.getYOffset()),
                (double)(p_184319_3_ * (float)pistonFacing.getZOffset()));
}
...
void TileEntityPiston::readFromNBT(NBTTagCompound *compound)
{
    ...
    pistonState =
        Block::getBlockById(compound->getInteger("blockId")).getStateFromMeta(compound->getInteger("blockData"));
    ...
    if ((double)progress >= 1.0 || enumfacing != (extending ? pistonFacing : pistonFacing.getOpposite()))
    {
        ...
        if (shouldPistonHeadBeRendered())
        {
            iblockstate = Blocks::PISTON_HEAD::getDefaultState()
                              ...
                              .withProperty(BlockPistonExtension::SHORT, extending != 1.0F - progress < 0.25F);
        }
        else
        {
...
{
    return !isExtending() && shouldPistonHeadBeRendered()
               ? Blocks::PISTON_HEAD.getDefaultState()
                     .withProperty(BlockPistonExtension::TYPE, pistonState.getBlock() == Blocks::STICKY_PISTON
                                                                   ? BlockPistonExtension::EnumPistonType::STICKY
                                                                   : BlockPistonExtension::EnumPistonType::DEFAULT)
                     .withProperty(BlockPistonExtension::FACING, pistonState.getValue(BlockPistonBase::FACING))
               : pistonState;
}
...
void TileEntityPiston::moveCollidedEntities(float p_184322_1_)
{
    ...
    getCollisionRelatedBlockState().addCollisionBoxToList(world, BlockPos::ORIGIN, AxisAlignedBB(BlockPos::ORIGIN),
                                                          list, nullptr, true);
    if (!list.empty())
    {
        AxisAlignedBB axisalignedbb = moveByPositionAndProgress(getMinMaxPiecesAABB(list));
        auto list1                  = world->getEntitiesWithinAABBExcludingEntity(
                             nullptr, getMovementArea(axisalignedbb, enumfacing, d0).aunion(axisalignedbb));
        if (!list1.isEmpty())
        {
                ...
                if (entity->getPushReaction() != EnumPushReaction::IGNORE)
                {
                    ...
                    for (int j = 0; j < list.size(); ++j)
                    {
                        AxisAlignedBB axisalignedbb1 =
                            getMovementArea(moveByPositionAndProgress((AxisAlignedBB)list[j]), enumfacing, d0);
                    ...
                    if (d1 > 0.0)
                    {
                        ...
                        entity->move(MoverType::PISTON, d1 * (double)enumfacing.getXOffset(),
                                     d1 * (double)enumfacing.getYOffset(), d1 * (double)enumfacing.getZOffset());
...
AxisAlignedBB TileEntityPiston::moveByPositionAndProgress(AxisAlignedBB p_190607_1_)
{
    ...
    return p_190607_1_.offset((double)pos.getx() + d0 * (double)pistonFacing.getXOffset(),
                              (double)pos.gety() + d0 * (double)pistonFacing.getYOffset(),
                              (double)pos.getz() + d0 * (double)pistonFacing.getZOffset());
}
...
AxisAlignedBB TileEntityPiston::getMovementArea(AxisAlignedBB p_190610_1_, EnumFacing p_190610_2_, double p_190610_3_)
{
    ...
    case EnumFacing::WEST:
        return AxisAlignedBB(p_190610_1_.getminX() + d1, p_190610_1_.getminY(), p_190610_1_.getminZ(),
                             p_190610_1_.getminX() + d2, p_190610_1_.getmaxY(), p_190610_1_.getmaxZ());
    case EnumFacing::EAST:
        return AxisAlignedBB(p_190610_1_.getmaxX() + d1, p_190610_1_.getminY(), p_190610_1_.getminZ(),
                             p_190610_1_.getmaxX() + d2, p_190610_1_.getmaxY(), p_190610_1_.getmaxZ());
    case EnumFacing::DOWN:
        return AxisAlignedBB(p_190610_1_.getminX(), p_190610_1_.getminY() + d1, p_190610_1_.getminZ(),
                             p_190610_1_.getmaxX(), p_190610_1_.getminY() + d2, p_190610_1_.getmaxZ());
    case EnumFacing::UP:
    default:
        return AxisAlignedBB(p_190610_1_.getminX(), p_190610_1_.getmaxY() + d1, p_190610_1_.getminZ(),
                             p_190610_1_.getmaxX(), p_190610_1_.getmaxY() + d2, p_190610_1_.getmaxZ());
    case EnumFacing::NORTH:
        return AxisAlignedBB(p_190610_1_.getminX(), p_190610_1_.getminY(), p_190610_1_.getminZ() + d1,
                             p_190610_1_.getmaxX(), p_190610_1_.getmaxY(), p_190610_1_.getminZ() + d2);
    case EnumFacing::SOUTH:
        return AxisAlignedBB(p_190610_1_.getminX(), p_190610_1_.getminY(), p_190610_1_.getmaxZ() + d1,
                             p_190610_1_.getmaxX(), p_190610_1_.getmaxY(), p_190610_1_.getmaxZ() + d2);
    }
}
...
void TileEntityPiston::fixEntityWithinPistonBase(Entity *p_190605_1_, EnumFacing p_190605_2_, double p_190605_3_)
{
    ...
    if (axisalignedbb.intersects(axisalignedbb1))
    {
        ...
        if (MathHelper::abs(d0 - d1) < 0.01)
        {
            ...
            p_190605_1_->move(MoverType::PISTON, d0 * (double)enumfacing.getXOffset(),
                              d0 * (double)enumfacing.getYOffset(), d0 * (double)enumfacing.getZOffset());
            MOVING_ENTITY.set((Object) nullptr);
        }
    }
}
...
{
    return facing.getAxisDirection() == AxisDirection::POSITIVE ? p_190611_0_.getmaxX() - p_190611_2_.getminX()
                                                                : p_190611_2_.getmaxX() - p_190611_0_.getminX();
}

double TileEntityPiston::getDeltaY(AxisAlignedBB p_190608_0_, EnumFacing facing, AxisAlignedBB p_190608_2_)
{
    return facing.getAxisDirection() == AxisDirection::POSITIVE ? p_190608_0_.getmaxY() - p_190608_2_.getminY()
                                                                : p_190608_2_.getmaxY() - p_190608_0_.getminY();
}

double TileEntityPiston::getDeltaZ(AxisAlignedBB p_190604_0_, EnumFacing facing, AxisAlignedBB p_190604_2_)
{
    return facing.getAxisDirection() == AxisDirection::POSITIVE ? p_190604_0_.getmaxZ() - p_190604_2_.getminZ()
                                                                : p_190604_2_.getmaxZ() - p_190604_0_.getminZ();
}
