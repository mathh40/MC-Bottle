...
class TileEntityHopper : public TileEntityLockableLoot, IHopper, ITickable
{
  public:
    ...
    static ItemStack putStackInInventoryAllSlots(IInventory *source, IInventory *destination, ItemStack stack,
  ...
  private:
    ...
    ItemStack insertStack(IInventory *source, IInventory *destination, ItemStack stack, int32_t index,
