...
class TileEntityPiston : public TileEntity, ITickable
{
  public:
    ...
    TileEntityPiston(IBlockState *pistonStateIn, EnumFacing pistonFacingIn, bool extendingIn,
    ...
    void addCollissionAABBs(World *p_190609_1_, BlockPos p_190609_2_, AxisAlignedBB p_190609_3_,
                            std::vector<> p_190609_4_, Entity *p_190609_5_);
  ...
  private:
    ...
    static ThreadLocal MOVING_ENTITY = new ThreadLocal(){protected : EnumFacing initialValue(){return nullptr;
}
}
;
float progress;
