...
void TileEntityEnderChest::update()
{
    ...
    if (numPlayersUsing > 0 && lidAngle == 0.0F)
    {
        ...
        d3        = (double)k + 0.5;
        world->playSound(nullptr, d0, (double)j + 0.5, d3, SoundEvents::BLOCK_ENDERCHEST_OPEN, SoundCategory::BLOCKS,
    ...
    if (numPlayersUsing == 0 && lidAngle > 0.0F || numPlayersUsing > 0 && lidAngle < 1.0F)
    {
        ...
        if (lidAngle < 0.5F && f2 >= 0.5F)
        {
            ...
            world->playSound(nullptr, d3, (double)j + 0.5, d2, SoundEvents::BLOCK_ENDERCHEST_CLOSE,
                             SoundCategory::BLOCKS, 0.5F, MathHelper::nextFloat(world->rand) * 0.1F + 0.9F);
        }
